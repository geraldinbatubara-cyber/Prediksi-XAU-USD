...
def render_live_trading(
    ...
    if (
        ...
        delay_frame = pd.DataFrame(
            [
                {
                    "Parameter": "Kode diagnosis",
                    "Nilai": fixed_delay_state.get("Kode diagnosis", "-"),
                },
                {
                    "Parameter": "Status candle harian terbaru",
                    "Nilai": fixed_delay_state.get("Status sinyal harian", "-"),
                },
                {
                    "Parameter": "Interpretasi candle harian",
                    "Nilai": fixed_delay_state.get("Interpretasi sinyal harian", "-"),
                },
                {
                    "Parameter": "Jumlah sinyal v1 sejak aktivasi",
                    "Nilai": fixed_delay_state.get(
                        "Jumlah sinyal harian sejak aktivasi", "-"
                    ),
                },
                {
                    "Parameter": "Sinyal harian terakhir",
                    "Nilai": _format_date(
                        fixed_delay_state.get("Sinyal harian terakhir")
                    ),
                },
                {
