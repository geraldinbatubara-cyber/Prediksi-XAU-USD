...
OUTPUT_PATH = (
    ...
    / "data"
    / "precomputed"
    / "v1_sideways_specialist_v8.pkl.b64"
)
V7_PATH = (
    PROJECT_ROOT
    / "data"
...
VERSION = "optimizer-v1-sideways-specialist-adaptive-range-2022-2026h1-v8"
...
def main() -> None:
    ...
    payload = run_v1_sideways_specialist_v8(
        gold_m1,
        frozen,
        _load_b64_payload(V7_PATH),
    )
