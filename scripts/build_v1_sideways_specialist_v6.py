...
from gold_forecast.v1_sideways_specialist_v6 import (
    run_v1_sideways_specialist_v6,
)
...
VERSION = "optimizer-v1-sideways-specialist-defense-opportunity-2022-2026h1-v6"
...
def main() -> None:
    ...
    payload = run_v1_sideways_specialist_v6(
        gold_m1,
        frozen,
        _load_b64_payload(DEFENSE_PATH),
        _load_b64_payload(V5_EXTENSIONS_PATH),
    )
    ...
    print(
        ...
        f"classifier={payload['methodology']['Selected defense classifier']}"
    )
