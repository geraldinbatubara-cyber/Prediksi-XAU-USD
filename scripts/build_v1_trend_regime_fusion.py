...
from gold_forecast.v1_trend_regime_fusion import (
    run_v1_trend_regime_fusion_lab,
)
...
OUTPUT_PATH = (
    PROJECT_ROOT / "data" / "precomputed" / "v1_trend_regime_fusion.pkl.b64"
)
VERSION = "optimizer-v1-trend-regime-fusion-2022-2026h1-v1"
...
def main() -> None:
    ...
    payload = run_v1_trend_regime_fusion_lab(
        gold_m1,
    ...
    print(
        f"Trend-Regime Fusion selesai | winner={winner['Kandidat']} | "
