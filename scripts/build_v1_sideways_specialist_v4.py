...
from gold_forecast.v1_sideways_specialist_v4 import (
    run_v1_sideways_specialist_v4_lab,
)
...
OUTPUT_PATH = (
    PROJECT_ROOT / "data" / "precomputed" / "v1_sideways_specialist_v4.pkl.b64"
)
V3_PATH = PROJECT_ROOT / "data" / "precomputed" / "v1_sideways_specialist_v3.pkl.b64"
VERSION = "optimizer-v1-sideways-specialist-event-hazard-2022-2026h1-v4"
...
def main() -> None:
    ...
    v3_payload = None
    if V3_PATH.exists():
        artifact = pickle.loads(base64.b64decode(V3_PATH.read_bytes()))
        v3_payload = artifact.get("payload")
    payload = run_v1_sideways_specialist_v4_lab(
        gold_m1, frozen, v3_payload
    )
    ...
    print(
        f"Sideways Specialist v4 selesai | selection={payload['selection_status']} | "
