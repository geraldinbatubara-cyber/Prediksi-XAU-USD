...
from gold_forecast.martingale_v2 import run_martingale_v2


OUTPUT_PATH = PROJECT_ROOT / "data" / "precomputed" / "martingale_v2.pkl"
VERSION = "martingale-v2-adaptive-train2025-oos2026h1"


def main() -> None:
    full_result, leaderboard, train_result, oos_result = run_martingale_v2(load_gold_data())
