...
from gold_forecast.v1_sideways_specialist import run_v1_sideways_specialist_lab
...
OUTPUT_PATH = PROJECT_ROOT / "data" / "precomputed" / "v1_sideways_specialist.pkl.b64"
DEFENSE_PATH = PROJECT_ROOT / "data" / "precomputed" / "v1_sideways_defense.pkl.b64"
VERSION = "optimizer-v1-sideways-specialist-range-mean-reversion-2022-2026h1-v1"
...
def main() -> None:
    ...
    if DEFENSE_PATH.exists():
        artifact = pickle.loads(base64.b64decode(DEFENSE_PATH.read_bytes()))
        defense_payload = artifact.get("payload")
    payload = run_v1_sideways_specialist_lab(
        gold_m1, frozen, defense_payload
    )
    ...
    print(
        f"Sideways Specialist selesai | selection={payload['selection_status']} | "
