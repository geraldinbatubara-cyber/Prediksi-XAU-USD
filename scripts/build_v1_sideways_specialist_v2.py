...
from gold_forecast.v1_sideways_specialist_v2 import (
    run_v1_sideways_specialist_v2_lab,
)
...
OUTPUT_PATH = (
    PROJECT_ROOT / "data" / "precomputed" / "v1_sideways_specialist_v2.pkl.b64"
)
V1_PATH = PROJECT_ROOT / "data" / "precomputed" / "v1_sideways_specialist.pkl.b64"
VERSION = "optimizer-v1-sideways-specialist-persistence-hazard-2022-2026h1-v2"
...
def main() -> None:
    ...
    v1_payload = None
    if V1_PATH.exists():
        artifact = pickle.loads(base64.b64decode(V1_PATH.read_bytes()))
        v1_payload = artifact.get("payload")
    payload = run_v1_sideways_specialist_v2_lab(
        gold_m1, frozen, v1_payload
    )
    ...
    print(
        f"Sideways Specialist v2 selesai | selection={payload['selection_status']} | "
