...
from gold_forecast.v1_sell_specialist import run_v1_sell_specialist_lab
...
OUTPUT_PATH = PROJECT_ROOT / "data" / "precomputed" / "v1_sell_specialist.pkl.b64"
VERSION = "optimizer-v1-directional-specialist-sell-2022-2026h1-v5"
...
def main() -> None:
    ...
    payload = run_v1_sell_specialist_lab(gold_m1, frozen)
    ...
    print(
        f"SELL Specialist v5 selesai | winner={winner['Kandidat']} | "
        f"criteria={winner['Kriteria lolos']}/10 | passed={winner['Lulus']}"
    )
